    ...
    def build_optimizer(cls, cfg, model):
        ...
        for module_name, module in model.named_modules():
            for module_param_name, value in module.named_parameters(recurse=False):
                ...
                if "cluster_embeddings" in module_param_name:
                    hyperparams["lr"] = hyperparams["lr"] * cfg.SOLVER.CLIP_MULTIPLIER
                if "prompt_tokens" in module_param_name:
                    hyperparams["lr"] = hyperparams["lr"] * cfg.SOLVER.PROMPT_MULTIPLIER
...
def setup(args):
    ...
    # Setup logger for "pixelclip" module
    setup_logger(output=cfg.OUTPUT_DIR, distributed_rank=comm.get_rank(), name="pixelclip")
    return cfg
